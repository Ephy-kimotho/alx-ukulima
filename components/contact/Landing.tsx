...
function Landing() {
  return (
    <section
      className={`min-h-screen bg-[url(/images/contact5.jpg)] md:bg-[url(/images/contact3.png)] bg-center bg-cover inset-shadow-overlay ${nunito.className} text-white flex  pt-32`}
    >
